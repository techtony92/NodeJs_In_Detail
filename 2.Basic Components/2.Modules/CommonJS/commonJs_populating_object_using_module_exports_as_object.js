 ...
 * *
 * 
 * * One thing to note: The module.exports declaration will override any exports declaration `IN THE SAME FILE` and they are NOT the same object.
*/

/**
 * * Named export. This is not an official name, just very similar to named exports in ES6. This 
 * * approach populates the module.exports object with members that can be `required` using a named export 
...
function endingNotes(){
    ...
    console.log(`This module syntax that is currently still in use\n`)
}
const memberFunctionFromModuleExports = () =>{
    console.log("From module.exports. This appends the function memberFunctionFromModuleExports \ninto the object exports via the parent object 'module'\n");
}

const helloFromModuleExports = function(){
    console.log(`From module.exports. This appends the function helloFunctionFromModuleExports \ninto the object exports via the parent object 'module'\n`);
    endingNotes();
}
module.exports = {memberFunctionFromModuleExports,helloFromModuleExports};
